...
3. Create a shortcut of this file and copy it to "C:\Documents and Settings\[User Name]\Start Menu\Programs\Startup" if you are running older version of windows or otherwise to "C:\Users\[User Name]\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup".
